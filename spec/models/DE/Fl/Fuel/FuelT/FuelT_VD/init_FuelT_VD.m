...
FuelT_tFlSys= Calibration.Signal;
...
FuelT_tTransStgDfl_C = Calibration.Parameter;
FuelT_tTransStgDfl_C.Value = 100;
FuelT_tTransStgDfl_C.CoderInfo.StorageClass = 'Custom';
FuelT_tTransStgDfl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FuelT_RmpSlpPos_C = Calibration.Parameter;
FuelT_RmpSlpPos_C.Value = 10;
FuelT_RmpSlpPos_C.CoderInfo.StorageClass = 'Custom';
FuelT_RmpSlpPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FuelT_RmpSlpNeg_C = Calibration.Parameter;
FuelT_RmpSlpNeg_C.Value = 10;
FuelT_RmpSlpNeg_C.CoderInfo.StorageClass = 'Custom';
FuelT_RmpSlpNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FuelT_facSerPT1T_C = Calibration.Parameter;
FuelT_facSerPT1T_C.Value = 50;
FuelT_facSerPT1T_C.CoderInfo.StorageClass = 'Custom';
FuelT_facSerPT1T_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_tFuelT_C = Calibration.Parameter;
SigTst_tFuelT_C.Value = 20;
SigTst_tFuelT_C.CoderInfo.StorageClass = 'Custom';
SigTst_tFuelT_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_swtFuelT_C = Calibration.Parameter;
SigTst_swtFuelT_C.Value = Switch_conv.OFF;
SigTst_swtFuelT_C.CoderInfo.StorageClass = 'Custom';
SigTst_swtFuelT_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FuelT_tDflFlSys_C = Calibration.Parameter;
FuelT_tDflFlSys_C.Value = 25;
FuelT_tDflFlSys_C.CoderInfo.StorageClass = 'Custom';
FuelT_tDflFlSys_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FuelT_swtTempSel_C = Calibration.Parameter;
FuelT_swtTempSel_C.Value = 0;
FuelT_swtTempSel_C.CoderInfo.StorageClass = 'Custom';
FuelT_swtTempSel_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
