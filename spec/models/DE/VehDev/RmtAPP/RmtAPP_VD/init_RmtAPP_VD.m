...
RmtAPP_uUnJit_mp= Calibration.Signal;
...
RmtAPP_rLinAPP_mp= Calibration.Signal;
...
RmtAPP_drUnFlt= Calibration.Signal;
...
RmtAPP_rUnFlt= Calibration.Signal;
...
RmtAPP_rFlt_mp= Calibration.Signal;
...
RmtAPP_rUnFlt_mp= Calibration.Signal;
...
RmtAPP_facPT1= Calibration.Signal;
...
RmtAPP_uJitter_C = Calibration.Parameter;
RmtAPP_uJitter_C.Value = 3;
RmtAPP_uJitter_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_uJitter_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_swtEnaUnJit_C = Calibration.Parameter;
RmtAPP_swtEnaUnJit_C.Value = Switch_conv.OFF;
RmtAPP_swtEnaUnJit_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_swtEnaUnJit_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
MoFRmtAPP_rLinAPPCURCalMsgA_CURX = Calibration.Parameter;
MoFRmtAPP_rLinAPPCURCalMsgA_CURX.Value = [1000 3390];
MoFRmtAPP_rLinAPPCURCalMsgA_CURX.CoderInfo.StorageClass = 'Custom';
MoFRmtAPP_rLinAPPCURCalMsgA_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
MoFRmtAPP_rLinAPPCURCalMsgA_CUR = Calibration.Parameter;
MoFRmtAPP_rLinAPPCURCalMsgA_CUR.Value = [0 100];
MoFRmtAPP_rLinAPPCURCalMsgA_CUR.CoderInfo.StorageClass = 'Custom';
MoFRmtAPP_rLinAPPCURCalMsgA_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_drLinRmp_C = Calibration.Parameter;
RmtAPP_drLinRmp_C.Value = 5;
RmtAPP_drLinRmp_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_drLinRmp_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_rThrFltLowNeg_C = Calibration.Parameter;
RmtAPP_rThrFltLowNeg_C.Value = 25;
RmtAPP_rThrFltLowNeg_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_rThrFltLowNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_rThrFltMidNeg_C = Calibration.Parameter;
RmtAPP_rThrFltMidNeg_C.Value = 50;
RmtAPP_rThrFltMidNeg_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_rThrFltMidNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_rThrFltLowPos_C = Calibration.Parameter;
RmtAPP_rThrFltLowPos_C.Value = 25;
RmtAPP_rThrFltLowPos_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_rThrFltLowPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_rThrFltMidPos_C = Calibration.Parameter;
RmtAPP_rThrFltMidPos_C.Value = 50;
RmtAPP_rThrFltMidPos_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_rThrFltMidPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facUppNegPT1_C = Calibration.Parameter;
RmtAPP_facUppNegPT1_C.Value = 50;
RmtAPP_facUppNegPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facUppNegPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facMidNegPT1_C = Calibration.Parameter;
RmtAPP_facMidNegPT1_C.Value = 50;
RmtAPP_facMidNegPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facMidNegPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facLowNegPT1_C = Calibration.Parameter;
RmtAPP_facLowNegPT1_C.Value = 50;
RmtAPP_facLowNegPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facLowNegPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facUppPosPT1_C = Calibration.Parameter;
RmtAPP_facUppPosPT1_C.Value = 50;
RmtAPP_facUppPosPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facUppPosPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facMidPosPT1_C = Calibration.Parameter;
RmtAPP_facMidPosPT1_C.Value = 50;
RmtAPP_facMidPosPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facMidPosPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_facLowPosPT1_C = Calibration.Parameter;
RmtAPP_facLowPosPT1_C.Value = 50;
RmtAPP_facLowPosPT1_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_facLowPosPT1_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_rRmtAPP_C = Calibration.Parameter;
SigTst_rRmtAPP_C.Value = 0;
SigTst_rRmtAPP_C.CoderInfo.StorageClass = 'Custom';
SigTst_rRmtAPP_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_swtRmtAPP_C = Calibration.Parameter;
SigTst_swtRmtAPP_C.Value = Switch_conv.OFF;
SigTst_swtRmtAPP_C.CoderInfo.StorageClass = 'Custom';
SigTst_swtRmtAPP_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
RmtAPP_swtEnaFlt_C = Calibration.Parameter;
RmtAPP_swtEnaFlt_C.Value = Switch_conv.OFF;
RmtAPP_swtEnaFlt_C.CoderInfo.StorageClass = 'Custom';
RmtAPP_swtEnaFlt_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
