...
RmtAPP_uRaw_mp= Simulink.Signal;
...
RmtAPP_stSigSrc_APPLIMP_BP= Simulink.Signal;
...
RmtAPP_stSigSrc_APPDEF_BP= Simulink.Signal;
...
RmtAPP_stSigSrc_APP1_BP= Simulink.Signal;
...
RmtAPP_stSigSrc_APP2_BP= Simulink.Signal;
...
RmtAPP_stTempErr_mp= Simulink.Signal;
...
RmtAPP_uRaw2Offset_C = Simulink.Parameter;
RmtAPP_uRaw2Offset_C.Value = 0;
RmtAPP_uRaw2Offset_C.CoderInfo.StorageClass = 'ImportedExtern';
...
RmtAPP_uAPPDef_C = Simulink.Parameter;
RmtAPP_uAPPDef_C.Value = 0;
RmtAPP_uAPPDef_C.CoderInfo.StorageClass = 'ImportedExtern';
...
RmtAPP_duLimErrPos_C = Simulink.Parameter;
RmtAPP_duLimErrPos_C.Value = 500;
RmtAPP_duLimErrPos_C.CoderInfo.StorageClass = 'ImportedExtern';
