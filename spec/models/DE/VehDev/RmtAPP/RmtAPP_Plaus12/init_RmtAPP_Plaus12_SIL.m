...
RmtAPP_bSyncDeb= Simulink.Signal;
...
RmtAPP_bSyncDeb_DSM= Simulink.Signal;
...
RmtAPP_uMin12half_mp= Simulink.Signal;
...
RmtAPP_uDiff_mp= Simulink.Signal;
...
RmtAPP_uDiffMax_mp= Simulink.Signal;
...
RmtAPP_uSyncMin_C = Simulink.Parameter;
RmtAPP_uSyncMin_C.Value = 750;
RmtAPP_uSyncMin_C.CoderInfo.StorageClass = 'ImportedExtern';
...
MoFRmtAPP_uSync_CURX = Simulink.Parameter;
MoFRmtAPP_uSync_CURX.Value = [0 2500];
MoFRmtAPP_uSync_CURX.CoderInfo.StorageClass = 'ImportedExtern';
...
MoFRmtAPP_uSync_CUR = Simulink.Parameter;
MoFRmtAPP_uSync_CUR.Value = [150 230];
MoFRmtAPP_uSync_CUR.CoderInfo.StorageClass = 'ImportedExtern';
...
RmtAPP_PlaAPPDefDeb_C = Simulink.Parameter;
RmtAPP_PlaAPPDefDeb_C.Value = 200;
RmtAPP_PlaAPPDefDeb_C.CoderInfo.StorageClass = 'ImportedExtern';
...
RmtAPP_PlaAPPDefOK_C = Simulink.Parameter;
RmtAPP_PlaAPPDefOK_C.Value = 200;
RmtAPP_PlaAPPDefOK_C.CoderInfo.StorageClass = 'ImportedExtern';
