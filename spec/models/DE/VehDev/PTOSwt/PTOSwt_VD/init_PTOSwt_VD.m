...
MoFPTO_swtPos_mp= Calibration.Signal;
...
PTOSwt_stDfl_C = Calibration.Parameter;
PTOSwt_stDfl_C.Value = 0;
PTOSwt_stDfl_C.CoderInfo.StorageClass = 'Custom';
PTOSwt_stDfl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_swtPTOSwt = Calibration.Parameter;
SigTst_swtPTOSwt.Value = Switch_conv.OFF;
SigTst_swtPTOSwt.CoderInfo.StorageClass = 'Custom';
SigTst_swtPTOSwt.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_stPTOSwt = Calibration.Parameter;
SigTst_stPTOSwt.Value = 0;
SigTst_stPTOSwt.CoderInfo.StorageClass = 'Custom';
SigTst_stPTOSwt.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
PTOSwt_bDfl_C = Calibration.Parameter;
PTOSwt_bDfl_C.Value = 0;
PTOSwt_bDfl_C.CoderInfo.StorageClass = 'Custom';
PTOSwt_bDfl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
PTOSwt_bEnblSwt_C = Calibration.Parameter;
PTOSwt_bEnblSwt_C.Value = 0;
PTOSwt_bEnblSwt_C.CoderInfo.StorageClass = 'Custom';
PTOSwt_bEnblSwt_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
