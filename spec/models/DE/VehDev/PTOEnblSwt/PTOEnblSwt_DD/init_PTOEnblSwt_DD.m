...
PTOEnblSwt_st= Calibration.Signal;
...
PTOEnblSwt_tiDebLoHi_C = Calibration.Parameter;
PTOEnblSwt_tiDebLoHi_C.Value = 300;
PTOEnblSwt_tiDebLoHi_C.CoderInfo.StorageClass = 'Custom';
PTOEnblSwt_tiDebLoHi_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
PTOEnblSwt_tiDebHiLo_C = Calibration.Parameter;
PTOEnblSwt_tiDebHiLo_C.Value = 300;
PTOEnblSwt_tiDebHiLo_C.CoderInfo.StorageClass = 'Custom';
PTOEnblSwt_tiDebHiLo_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
PTOEnblSwt_stDflVal_C = Calibration.Parameter;
PTOEnblSwt_stDflVal_C.Value = 0;
PTOEnblSwt_stDflVal_C.CoderInfo.StorageClass = 'Custom';
PTOEnblSwt_stDflVal_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
PTOEnblSwt_swtSigSel_C = Calibration.Parameter;
PTOEnblSwt_swtSigSel_C.Value = Switch_conv.ON;
PTOEnblSwt_swtSigSel_C.CoderInfo.StorageClass = 'Custom';
PTOEnblSwt_swtSigSel_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
