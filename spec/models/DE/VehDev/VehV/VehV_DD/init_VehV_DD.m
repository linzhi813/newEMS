...
VehV_nRawCrdSh= Calibration.Signal;
...
VehV_bSwtPrs= Calibration.Signal;
...
VehV_numImpCrdSh_C = Calibration.Parameter;
VehV_numImpCrdSh_C.Value = 2.55;
VehV_numImpCrdSh_C.CoderInfo.StorageClass = 'Custom';
VehV_numImpCrdSh_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
VehV_ImpPerDist_C = Calibration.Parameter;
VehV_ImpPerDist_C.Value = 5.2;
VehV_ImpPerDist_C.CoderInfo.StorageClass = 'Custom';
VehV_ImpPerDist_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
VehV_bSwtPrs_C = Calibration.Parameter;
VehV_bSwtPrs_C.Value = 0;
VehV_bSwtPrs_C.CoderInfo.StorageClass = 'Custom';
VehV_bSwtPrs_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
