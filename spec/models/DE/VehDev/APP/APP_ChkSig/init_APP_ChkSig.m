...
APP_rUnLim_mp= Calibration.Signal;
...
APP_rPla_mp= Calibration.Signal;
...
APP_stAlive_mp= Calibration.Signal;
...
APP_swtAliveDetEna_C = Calibration.Parameter;
APP_swtAliveDetEna_C.Value = Switch_conv.OFF;
APP_swtAliveDetEna_C.CoderInfo.StorageClass = 'Custom';
APP_swtAliveDetEna_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_tiAliveDebLoHi_C = Calibration.Parameter;
APP_tiAliveDebLoHi_C.Value = 0;
APP_tiAliveDebLoHi_C.CoderInfo.StorageClass = 'Custom';
APP_tiAliveDebLoHi_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_tiAliveDebHiLo_C = Calibration.Parameter;
APP_tiAliveDebHiLo_C.Value = 300;
APP_tiAliveDebHiLo_C.CoderInfo.StorageClass = 'Custom';
APP_tiAliveDebHiLo_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rThresAliveDet_C = Calibration.Parameter;
APP_rThresAliveDet_C.Value = 20;
APP_rThresAliveDet_C.CoderInfo.StorageClass = 'Custom';
APP_rThresAliveDet_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_drLimpMax_C = Calibration.Parameter;
APP_drLimpMax_C.Value = 40;
APP_drLimpMax_C.CoderInfo.StorageClass = 'Custom';
APP_drLimpMax_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rLimpMax_C = Calibration.Parameter;
APP_rLimpMax_C.Value = 0;
APP_rLimpMax_C.CoderInfo.StorageClass = 'Custom';
APP_rLimpMax_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rPlaMaxVal_C = Calibration.Parameter;
APP_rPlaMaxVal_C.Value = 0;
APP_rPlaMaxVal_C.CoderInfo.StorageClass = 'Custom';
APP_rPlaMaxVal_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_drLimPos_C = Calibration.Parameter;
APP_drLimPos_C.Value = 10;
APP_drLimPos_C.CoderInfo.StorageClass = 'Custom';
APP_drLimPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_drLimNeg_C = Calibration.Parameter;
APP_drLimNeg_C.Value = 10;
APP_drLimNeg_C.CoderInfo.StorageClass = 'Custom';
APP_drLimNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_swtPlaChkEna_C = Calibration.Parameter;
APP_swtPlaChkEna_C.Value = Switch_conv.ON;
APP_swtPlaChkEna_C.CoderInfo.StorageClass = 'Custom';
APP_swtPlaChkEna_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rRmtAPPThresTrqDem_C = Calibration.Parameter;
APP_rRmtAPPThresTrqDem_C.Value = 10;
APP_rRmtAPPThresTrqDem_C.CoderInfo.StorageClass = 'Custom';
APP_rRmtAPPThresTrqDem_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_stRmtAppTrqEN_C = Calibration.Parameter;
APP_stRmtAppTrqEN_C.Value = 0;
APP_stRmtAppTrqEN_C.CoderInfo.StorageClass = 'Custom';
APP_stRmtAppTrqEN_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_tiRmtAppEN_C = Calibration.Parameter;
APP_tiRmtAppEN_C.Value = 100;
APP_tiRmtAppEN_C.CoderInfo.StorageClass = 'Custom';
APP_tiRmtAppEN_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rRmtAPPThresTrqDemL_C = Calibration.Parameter;
APP_rRmtAPPThresTrqDemL_C.Value = 2;
APP_rRmtAPPThresTrqDemL_C.CoderInfo.StorageClass = 'Custom';
APP_rRmtAPPThresTrqDemL_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
APP_rRmtAPPThresTrqDemH_C = Calibration.Parameter;
APP_rRmtAPPThresTrqDemH_C.Value = 3;
APP_rRmtAPPThresTrqDemH_C.CoderInfo.StorageClass = 'Custom';
APP_rRmtAPPThresTrqDemH_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
