...
load testcase_ECBtn_DD_002.mat;

% add changed cal variables for this test case from initTST_ECBtn_DD_002.m

ECBtn_swtSigSelStrt_C = Calibration.Parameter;
ECBtn_swtSigSelStrt_C.Value = 1;
