...
Gbx_NPosDeb_tiHiLo_C = Simulink.Parameter;
Gbx_NPosDeb_tiHiLo_C.Value = 400;
Gbx_NPosDeb_tiHiLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
Gbx_NPosDeb_tiLoHi_C = Simulink.Parameter;
Gbx_NPosDeb_tiLoHi_C.Value = 400;
Gbx_NPosDeb_tiLoHi_C.CoderInfo.StorageClass = 'ImportedExtern';
