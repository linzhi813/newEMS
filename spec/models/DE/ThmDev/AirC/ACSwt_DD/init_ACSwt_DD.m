...
AirC_tiSwtDebLoHi_C = Calibration.Parameter;
AirC_tiSwtDebLoHi_C.Value = 10;
AirC_tiSwtDebLoHi_C.CoderInfo.StorageClass = 'Custom';
AirC_tiSwtDebLoHi_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
AirC_tiSwtDebHiLo_C = Calibration.Parameter;
AirC_tiSwtDebHiLo_C.Value = 10;
AirC_tiSwtDebHiLo_C.CoderInfo.StorageClass = 'Custom';
AirC_tiSwtDebHiLo_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
