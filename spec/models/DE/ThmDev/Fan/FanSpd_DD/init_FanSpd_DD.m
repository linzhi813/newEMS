...
Fan_bSwtPrs= Calibration.Signal;
...
Fan_numImpRev_C = Calibration.Parameter;
Fan_numImpRev_C.Value = 100;
Fan_numImpRev_C.CoderInfo.StorageClass = 'Custom';
Fan_numImpRev_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Fan_bSwtPrs_C = Calibration.Parameter;
Fan_bSwtPrs_C.Value = 1;
Fan_bSwtPrs_C.CoderInfo.StorageClass = 'Custom';
Fan_bSwtPrs_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
