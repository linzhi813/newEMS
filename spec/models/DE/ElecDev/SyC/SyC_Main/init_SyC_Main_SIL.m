...
SyC_tiPostDrive_mp= Simulink.Signal;
...
SyC_tiPostDrive_C = Simulink.Parameter;
SyC_tiPostDrive_C.Value = 30000;
SyC_tiPostDrive_C.CoderInfo.StorageClass = 'ImportedExtern';
