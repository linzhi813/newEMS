...
Air_tTransStgTAFSDfl_C = Simulink.Parameter;
Air_tTransStgTAFSDfl_C.Value = 49.96;
Air_tTransStgTAFSDfl_C.CoderInfo.StorageClass = 'ImportedExtern';
...
Air_RmpSlpTAFSPos_C = Simulink.Parameter;
Air_RmpSlpTAFSPos_C.Value = 10;
Air_RmpSlpTAFSPos_C.CoderInfo.StorageClass = 'ImportedExtern';
...
Air_RmpSlpTAFSNeg_C = Simulink.Parameter;
Air_RmpSlpTAFSNeg_C.Value = 10;
Air_RmpSlpTAFSNeg_C.CoderInfo.StorageClass = 'ImportedExtern';
...
Air_facPT1TAFS_C = Simulink.Parameter;
Air_facPT1TAFS_C.Value = 50;
Air_facPT1TAFS_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_swtTAFS_C = Simulink.Parameter;
SigTst_swtTAFS_C.Value = Switch_conv.OFF;
SigTst_swtTAFS_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_tTAFS_C = Simulink.Parameter;
SigTst_tTAFS_C.Value = 50;
SigTst_tTAFS_C.CoderInfo.StorageClass = 'ImportedExtern';
