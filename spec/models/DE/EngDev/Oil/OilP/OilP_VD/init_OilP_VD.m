...
Oil_stPSwmp= Calibration.Signal;
...
Oil_pTransStgDfl_C = Calibration.Parameter;
Oil_pTransStgDfl_C.Value = 6;
Oil_pTransStgDfl_C.CoderInfo.StorageClass = 'Custom';
Oil_pTransStgDfl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Oil_RmpSlpPPos_C = Calibration.Parameter;
Oil_RmpSlpPPos_C.Value = 10;
Oil_RmpSlpPPos_C.CoderInfo.StorageClass = 'Custom';
Oil_RmpSlpPPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Oil_RmpSlpPNeg_C = Calibration.Parameter;
Oil_RmpSlpPNeg_C.Value = 10;
Oil_RmpSlpPNeg_C.CoderInfo.StorageClass = 'Custom';
Oil_RmpSlpPNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_pOilPSwmp_C = Calibration.Parameter;
SigTst_pOilPSwmp_C.Value = 100;
SigTst_pOilPSwmp_C.CoderInfo.StorageClass = 'Custom';
SigTst_pOilPSwmp_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
SigTst_swtOilPSwmp_C = Calibration.Parameter;
SigTst_swtOilPSwmp_C.Value = Switch_conv.OFF;
SigTst_swtOilPSwmp_C.CoderInfo.StorageClass = 'Custom';
SigTst_swtOilPSwmp_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Oil_facPT1FltP_C = Calibration.Parameter;
Oil_facPT1FltP_C.Value = 50;
Oil_facPT1FltP_C.CoderInfo.StorageClass = 'Custom';
Oil_facPT1FltP_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Oil_swtPresSensTyp_C = Calibration.Parameter;
Oil_swtPresSensTyp_C.Value = Switch_conv.OFF;
Oil_swtPresSensTyp_C.CoderInfo.StorageClass = 'Custom';
Oil_swtPresSensTyp_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
