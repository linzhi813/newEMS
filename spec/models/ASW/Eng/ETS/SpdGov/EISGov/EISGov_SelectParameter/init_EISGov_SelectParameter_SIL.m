...
EISGov_numCurrFunc= Simulink.Signal;
...
EISGov_nSetPLo= Simulink.Signal;
...
EISGov_nSetPHi= Simulink.Signal;
...
EISGov_KpCurrLo_mp= Simulink.Signal;
...
EISGov_KpPosCurrLo_mp= Simulink.Signal;
...
EISGov_KpNegCurrLo_mp= Simulink.Signal;
...
EISGov_PWinPosLo= Simulink.Signal;
...
EISGov_PWinNegLo= Simulink.Signal;
...
EISGov_KiCurrLo_mp= Simulink.Signal;
...
EISGov_KiPosCurrLo_mp= Simulink.Signal;
...
EISGov_KiNegCurrLo_mp= Simulink.Signal;
...
EISGov_IWinPosLo= Simulink.Signal;
...
EISGov_IWinNegLo= Simulink.Signal;
...
EISGov_KpCurrHi_mp= Simulink.Signal;
...
EISGov_KpPosCurrHi_mp= Simulink.Signal;
...
EISGov_KpNegCurrHi_mp= Simulink.Signal;
...
EISGov_PWinPosHi= Simulink.Signal;
...
EISGov_PWinNegHi= Simulink.Signal;
...
EISGov_KiCurrHi_mp= Simulink.Signal;
...
EISGov_KiPosCurrHi_mp= Simulink.Signal;
...
EISGov_KiNegCurrHi_mp= Simulink.Signal;
...
EISGov_IWinPosHi= Simulink.Signal;
...
EISGov_IWinNegHi= Simulink.Signal;
...
EISGov_stPrio_CA = Simulink.Parameter;
...
EISGov_stPrio_CA.CoderInfo.StorageClass = 'ImportedExtern';
...
EISGov_SetPLoRmpSlopePos_C = Simulink.Parameter;
EISGov_SetPLoRmpSlopePos_C.Value = 50;
EISGov_SetPLoRmpSlopePos_C.CoderInfo.StorageClass = 'ImportedExtern';
...
EISGov_SetPLoRmpSlopeNeg_C = Simulink.Parameter;
EISGov_SetPLoRmpSlopeNeg_C.Value = 250;
EISGov_SetPLoRmpSlopeNeg_C.CoderInfo.StorageClass = 'ImportedExtern';
