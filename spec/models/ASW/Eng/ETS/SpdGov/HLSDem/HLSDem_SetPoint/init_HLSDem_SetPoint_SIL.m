...
HLSDem_nSetPLo= Simulink.Signal;
...
HLSDem_nSetPHi= Simulink.Signal;
...
HLSDem_nSetPLoBas= Simulink.Signal;
...
HLSDem_trqFdbkFltLo_mp= Simulink.Signal;
...
HLSDem_nSetPLoCorVal_mp= Simulink.Signal;
...
HLSDem_nSetPLoMoF= Simulink.Signal;
...
HLSDem_tSetPLo_mp= Simulink.Signal;
...
HLSDem_tFrzSetPLo_mp= Simulink.Signal;
...
HLSDem_nSelSetPLo_mp= Simulink.Signal;
...
HLSDem_nSetPLoTemp= Simulink.Signal;
...
HLSDem_nSetPLoCo_mp= Simulink.Signal;
...
HLSDem_nSetPLoTrm= Simulink.Signal;
...
HLSDem_nSetPLoRaw_mp= Simulink.Signal;
...
HLSDem_stSetPLoFlt_mp= Simulink.Signal;
...
HLSDem_trqFdbkFltHi_mp= Simulink.Signal;
...
HLSDem_nSetPHiCorVal_mp= Simulink.Signal;
...
HLSDem_tiStrtCEngDsT_mp= Simulink.Signal;
...
HLSDem_tiStrtEngOil_mp= Simulink.Signal;
...
HLSDem_tiStrt_mp= Simulink.Signal;
...
HLSDem_stStrt_mp= Simulink.Signal;
...
HLSDem_nGear_mp= Simulink.Signal;
...
HLSDem_nStrtLub_mp= Simulink.Signal;
...
HLSDem_nRedSetPHi_mp= Simulink.Signal;
...
HLSDem_nSetPHiBas_mp= Simulink.Signal;
...
HLSDem_stNoRmp= Simulink.Signal;
...
HLSDem_stStrtTemp_mp= Simulink.Signal;
...
HLSDem_nSetPHiRaw_mp= Simulink.Signal;
...
HLSDem_facFdbk= Simulink.Signal;
...
HLSDem_facFdbkSysDgrt= Simulink.Signal;
...
HLSDem_nSpdLowBattUAdd_mp= Simulink.Signal;
...
HLSDem_swtTrqLoSel_C = Simulink.Parameter;
HLSDem_swtTrqLoSel_C.Value = 1;
HLSDem_swtTrqLoSel_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facTrqLoPT1_C = Simulink.Parameter;
HLSDem_facTrqLoPT1_C.Value = 50;
HLSDem_facTrqLoPT1_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoOfsMoF_C = Simulink.Parameter;
HLSDem_nSetPLoOfsMoF_C.Value = 0;
HLSDem_nSetPLoOfsMoF_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiMaxIncrSetPLo_C = Simulink.Parameter;
HLSDem_tiMaxIncrSetPLo_C.Value = 6000;
HLSDem_tiMaxIncrSetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tDflSetPLo_C = Simulink.Parameter;
HLSDem_tDflSetPLo_C.Value = 40;
HLSDem_tDflSetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_swtTempSel_C = Simulink.Parameter;
HLSDem_swtTempSel_C.Value = 1;
HLSDem_swtTempSel_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tThresDisbl_C = Simulink.Parameter;
HLSDem_tThresDisbl_C.Value = 50;
HLSDem_tThresDisbl_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_swtMode_C = Simulink.Parameter;
HLSDem_swtMode_C.Value = 1;
HLSDem_swtMode_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tThresEna_C = Simulink.Parameter;
HLSDem_tThresEna_C.Value = 10;
HLSDem_tThresEna_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoWrm_C = Simulink.Parameter;
HLSDem_nSetPLoWrm_C.Value = 680;
HLSDem_nSetPLoWrm_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSel1SetPLo_C = Simulink.Parameter;
HLSDem_nSel1SetPLo_C.Value = 700;
HLSDem_nSel1SetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSel2SetPLo_C = Simulink.Parameter;
HLSDem_nSel2SetPLo_C.Value = 700;
HLSDem_nSel2SetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSel3SetPLo_C = Simulink.Parameter;
HLSDem_nSel3SetPLo_C.Value = 700;
HLSDem_nSel3SetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_swtEnaPTO_C = Simulink.Parameter;
HLSDem_swtEnaPTO_C.Value = 1;
HLSDem_swtEnaPTO_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoIni_CURX = Simulink.Parameter;
HLSDem_nSetPLoIni_CURX.Value = [-130 -120 -100 -90 -80 -60 -50 -40 -20 -10 0 20 30 40 60 70 80 100 110];
HLSDem_nSetPLoIni_CURX.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoDrvAwy_C = Simulink.Parameter;
HLSDem_nSetPLoDrvAwy_C.Value = 682;
HLSDem_nSetPLoDrvAwy_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoDia_C = Simulink.Parameter;
HLSDem_nSetPLoDia_C.Value = 0;
HLSDem_nSetPLoDia_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoMax_C = Simulink.Parameter;
HLSDem_nSetPLoMax_C.Value = 2000;
HLSDem_nSetPLoMax_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_dnSetPLoLimLoTrm_C = Simulink.Parameter;
HLSDem_dnSetPLoLimLoTrm_C.Value = -200;
HLSDem_dnSetPLoLimLoTrm_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_dnSetPLoLimHiTrm_C = Simulink.Parameter;
HLSDem_dnSetPLoLimHiTrm_C.Value = 200;
HLSDem_dnSetPLoLimHiTrm_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSetPLoMaxOfs_C = Simulink.Parameter;
HLSDem_nSetPLoMaxOfs_C.Value = 0;
HLSDem_nSetPLoMaxOfs_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facSetPLoFlt_C = Simulink.Parameter;
HLSDem_facSetPLoFlt_C.Value = 50;
HLSDem_facSetPLoFlt_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPLoTipInRmpSlopePos_C = Simulink.Parameter;
HLSDem_SetPLoTipInRmpSlopePos_C.Value = 50;
HLSDem_SetPLoTipInRmpSlopePos_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPLoTipInRmpSlopeNeg_C = Simulink.Parameter;
HLSDem_SetPLoTipInRmpSlopeNeg_C.Value = 250;
HLSDem_SetPLoTipInRmpSlopeNeg_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPLoRmpSlopePos_C = Simulink.Parameter;
HLSDem_SetPLoRmpSlopePos_C.Value = 50;
HLSDem_SetPLoRmpSlopePos_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPLoRmpSlopeNeg_C = Simulink.Parameter;
HLSDem_SetPLoRmpSlopeNeg_C.Value = 250;
HLSDem_SetPLoRmpSlopeNeg_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_swtTrqHiSel_C = Simulink.Parameter;
HLSDem_swtTrqHiSel_C.Value = 1;
HLSDem_swtTrqHiSel_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facTrqHiPT1_C = Simulink.Parameter;
HLSDem_facTrqHiPT1_C.Value = 50;
HLSDem_facTrqHiPT1_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_rTrqSwt_C = Simulink.Parameter;
HLSDem_rTrqSwt_C.Value = 0.4;
HLSDem_rTrqSwt_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nHGGSetPHi_C = Simulink.Parameter;
HLSDem_nHGGSetPHi_C.Value = 2500;
HLSDem_nHGGSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nLGGSetPHi_C = Simulink.Parameter;
HLSDem_nLGGSetPHi_C.Value = 2500;
HLSDem_nLGGSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nStrtSetPHi_C = Simulink.Parameter;
HLSDem_nStrtSetPHi_C.Value = 2500;
HLSDem_nStrtSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nKDSetPHi_C = Simulink.Parameter;
HLSDem_nKDSetPHi_C.Value = 2500;
HLSDem_nKDSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nRed1SetPHi_C = Simulink.Parameter;
HLSDem_nRed1SetPHi_C.Value = 2500;
HLSDem_nRed1SetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nRed2SetPHi_C = Simulink.Parameter;
HLSDem_nRed2SetPHi_C.Value = 2500;
HLSDem_nRed2SetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nRed3SetPHi_C = Simulink.Parameter;
HLSDem_nRed3SetPHi_C.Value = 2500;
HLSDem_nRed3SetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPHiRmpSlopePos_C = Simulink.Parameter;
HLSDem_SetPHiRmpSlopePos_C.Value = 60;
HLSDem_SetPHiRmpSlopePos_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_SetPHiRmpSlopeNeg_C = Simulink.Parameter;
HLSDem_SetPHiRmpSlopeNeg_C.Value = 60;
HLSDem_SetPHiRmpSlopeNeg_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiStrtCEngDsT_CURX = Simulink.Parameter;
HLSDem_tiStrtCEngDsT_CURX.Value = [-30 -20 -10 0 10 20 30 40];
HLSDem_tiStrtCEngDsT_CURX.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiStrtCEngDsT_CUR = Simulink.Parameter;
HLSDem_tiStrtCEngDsT_CUR.Value = [63000 50000 40000 36000 27000 25000 18000 0];
HLSDem_tiStrtCEngDsT_CUR.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiStrtEngOil_CURX = Simulink.Parameter;
HLSDem_tiStrtEngOil_CURX.Value = [-30 -20 -10 0 10 20 30 40];
HLSDem_tiStrtEngOil_CURX.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiStrtEngOil_CUR = Simulink.Parameter;
HLSDem_tiStrtEngOil_CUR.Value = [62000 54000 45000 30000 20000 18000 15000 0];
HLSDem_tiStrtEngOil_CUR.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_swtDisblVehIfcSetPHi_C = Simulink.Parameter;
HLSDem_swtDisblVehIfcSetPHi_C.Value = Switch_conv.OFF;
HLSDem_swtDisblVehIfcSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_nSetPLo_C = Simulink.Parameter;
SigTst_nSetPLo_C.Value = 0;
SigTst_nSetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_swtSetPLo_C = Simulink.Parameter;
SigTst_swtSetPLo_C.Value = Switch_conv.OFF;
SigTst_swtSetPLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_stSysDgrtSetPHi_C = Simulink.Parameter;
HLSDem_stSysDgrtSetPHi_C.Value = 1;
HLSDem_stSysDgrtSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkSysDgrt3_C = Simulink.Parameter;
HLSDem_facFdbkSysDgrt3_C.Value = 0.61525;
HLSDem_facFdbkSysDgrt3_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkSysDgrt2_C = Simulink.Parameter;
HLSDem_facFdbkSysDgrt2_C.Value = 0.61525;
HLSDem_facFdbkSysDgrt2_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkSysDgrt1_C = Simulink.Parameter;
HLSDem_facFdbkSysDgrt1_C.Value = 0.61525;
HLSDem_facFdbkSysDgrt1_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_stSpdSel_C = Simulink.Parameter;
HLSDem_stSpdSel_C.Value = 1;
HLSDem_stSpdSel_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkLGG_C = Simulink.Parameter;
HLSDem_facFdbkLGG_C.Value = 0;
HLSDem_facFdbkLGG_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkHGG_C = Simulink.Parameter;
HLSDem_facFdbkHGG_C.Value = 0;
HLSDem_facFdbkHGG_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkStrt_C = Simulink.Parameter;
HLSDem_facFdbkStrt_C.Value = 0.33998;
HLSDem_facFdbkStrt_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkDrvKick_C = Simulink.Parameter;
HLSDem_facFdbkDrvKick_C.Value = 0.33998;
HLSDem_facFdbkDrvKick_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkCANKick_C = Simulink.Parameter;
HLSDem_facFdbkCANKick_C.Value = 0.33998;
HLSDem_facFdbkCANKick_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkRed1_C = Simulink.Parameter;
HLSDem_facFdbkRed1_C.Value = 0.33998;
HLSDem_facFdbkRed1_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkRed2_C = Simulink.Parameter;
HLSDem_facFdbkRed2_C.Value = 0.33998;
HLSDem_facFdbkRed2_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkRed3_C = Simulink.Parameter;
HLSDem_facFdbkRed3_C.Value = 0.33998;
HLSDem_facFdbkRed3_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkMaxAcs_C = Simulink.Parameter;
HLSDem_facFdbkMaxAcs_C.Value = 0;
HLSDem_facFdbkMaxAcs_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkMaxTra_C = Simulink.Parameter;
HLSDem_facFdbkMaxTra_C.Value = 0;
HLSDem_facFdbkMaxTra_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_facFdbkMaxSysErr_C = Simulink.Parameter;
HLSDem_facFdbkMaxSysErr_C.Value = 0;
HLSDem_facFdbkMaxSysErr_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSysDgrtSetPHi_C = Simulink.Parameter;
HLSDem_nSysDgrtSetPHi_C.Value = 6000;
HLSDem_nSysDgrtSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_nSetPHi_C = Simulink.Parameter;
SigTst_nSetPHi_C.Value = 0;
SigTst_nSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
SigTst_swtSetPHi_C = Simulink.Parameter;
SigTst_swtSetPHi_C.Value = Switch_conv.OFF;
SigTst_swtSetPHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HndBrk_stDebVal_C = Simulink.Parameter;
HndBrk_stDebVal_C.Value = 0;
HndBrk_stDebVal_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_stSetPLoFlt_C = Simulink.Parameter;
HLSDem_stSetPLoFlt_C.Value = 0;
HLSDem_stSetPLoFlt_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_volSpdAddLo_C = Simulink.Parameter;
HLSDem_volSpdAddLo_C.Value = 11000;
HLSDem_volSpdAddLo_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_volSpdAddHi_C = Simulink.Parameter;
HLSDem_volSpdAddHi_C.Value = 13000;
HLSDem_volSpdAddHi_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_tiSpdLowBattUAdd_C = Simulink.Parameter;
HLSDem_tiSpdLowBattUAdd_C.Value = 30000;
HLSDem_tiSpdLowBattUAdd_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSpdLowBattUAddLim_C = Simulink.Parameter;
HLSDem_nSpdLowBattUAddLim_C.Value = 300;
HLSDem_nSpdLowBattUAddLim_C.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSpdLowBattUAdd_CURX = Simulink.Parameter;
HLSDem_nSpdLowBattUAdd_CURX.Value = [10000 10400 10800 11200 11600 12000 12400 12800 13200 14000];
HLSDem_nSpdLowBattUAdd_CURX.CoderInfo.StorageClass = 'ImportedExtern';
...
HLSDem_nSpdLowBattUAdd_CUR = Simulink.Parameter;
HLSDem_nSpdLowBattUAdd_CUR.Value = [150 150 150 150 100 100 100 0 0 0];
HLSDem_nSpdLowBattUAdd_CUR.CoderInfo.StorageClass = 'ImportedExtern';
