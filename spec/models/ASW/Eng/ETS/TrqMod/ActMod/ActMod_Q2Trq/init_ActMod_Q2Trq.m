...
ActMod_trqInr= Calibration.Signal;
...
ActMod_trqCurr_mp= Calibration.Signal;
...
ActMod_swtStrtQntEna_C = Calibration.Parameter;
ActMod_swtStrtQntEna_C.Value = Switch_conv.ON;
ActMod_swtStrtQntEna_C.CoderInfo.StorageClass = 'Custom';
ActMod_swtStrtQntEna_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
