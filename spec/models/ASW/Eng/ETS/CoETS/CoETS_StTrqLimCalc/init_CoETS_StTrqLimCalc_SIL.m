...
CoETS_bLimInfo_DSM= Simulink.Signal;
...
CoETS_stCurrLim= Simulink.Signal;
...
CoETS_stCurrLimActive= Simulink.Signal;
...
CoETS_trqInrCurrLim= Simulink.Signal;
...
CoETS_trqInrVehLimMin_mp= Simulink.Signal;
...
CoETS_stLimInfo= Simulink.Signal;
...
CoETS_trqInrSecLimOVHT_mp= Simulink.Signal;
...
CoETS_trqInrSecLimHiPres= Simulink.Signal;
...
CoETS_nTrqRatMin_C = Simulink.Parameter;
CoETS_nTrqRatMin_C.Value = 100;
CoETS_nTrqRatMin_C.CoderInfo.StorageClass = 'ImportedExtern';
...
CoETS_trqInrCurrMinLim_C = Simulink.Parameter;
CoETS_trqInrCurrMinLim_C.Value = 0;
CoETS_trqInrCurrMinLim_C.CoderInfo.StorageClass = 'ImportedExtern';
...
CoETS_trqDiffMaxLim_C = Simulink.Parameter;
CoETS_trqDiffMaxLim_C.Value = 400;
CoETS_trqDiffMaxLim_C.CoderInfo.StorageClass = 'ImportedExtern';
...
Rail_stLimDetSetPoint_C = Simulink.Parameter;
Rail_stLimDetSetPoint_C.Value = 0;
Rail_stLimDetSetPoint_C.CoderInfo.StorageClass = 'ImportedExtern';
