...
Rail_stCtlLoop= Calibration.Signal;
...
MeUn_dvolSet= Calibration.Signal;
...
Rail_stMeUnFrzI= Calibration.Signal;
...
MeUn_dvolSetAdapt= Calibration.Signal;
...
Rail_pPT1Flt_mp= Calibration.Signal;
...
Rail_pDvtFltLim_mp= Calibration.Signal;
...
Rail_dvolMeUnCtlP_mp= Calibration.Signal;
...
Rail_dvolMeUnCtlI_mp= Calibration.Signal;
...
Rail_dvolMeUnCtlDT1_mp= Calibration.Signal;
...
Rail_dvolPRVCtlSet_mp= Calibration.Signal;
...
Rail_numRevPlaus_mp= Calibration.Signal;
...
Rail_numRevFrzl_mp= Calibration.Signal;
...
Rail_dvolMeUnCtlLim_mp= Calibration.Signal;
...
Rail_dvolMeUnCtl_mp= Calibration.Signal;
...
Rail_dvolMeUnCtlPID_mp= Calibration.Signal;
...
Rail_swtPress_C = Calibration.Parameter;
Rail_swtPress_C.Value = 0;
Rail_swtPress_C.CoderInfo.StorageClass = 'Custom';
Rail_swtPress_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_nStrtLoPress_C = Calibration.Parameter;
Rail_nStrtLoPress_C.Value = 0;
Rail_nStrtLoPress_C.CoderInfo.StorageClass = 'Custom';
Rail_nStrtLoPress_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pDiffCloseCtl_C = Calibration.Parameter;
Rail_pDiffCloseCtl_C.Value = 10;
Rail_pDiffCloseCtl_C.CoderInfo.StorageClass = 'Custom';
Rail_pDiffCloseCtl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pCloseCtl_C = Calibration.Parameter;
Rail_pCloseCtl_C.Value = 100;
Rail_pCloseCtl_C.CoderInfo.StorageClass = 'Custom';
Rail_pCloseCtl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_nOpnCtl_C = Calibration.Parameter;
Rail_nOpnCtl_C.Value = 40;
Rail_nOpnCtl_C.CoderInfo.StorageClass = 'Custom';
Rail_nOpnCtl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_numRevPlaus_C = Calibration.Parameter;
Rail_numRevPlaus_C.Value = 10;
Rail_numRevPlaus_C.CoderInfo.StorageClass = 'Custom';
Rail_numRevPlaus_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_nCloseCtl_C = Calibration.Parameter;
Rail_nCloseCtl_C.Value = 200;
Rail_nCloseCtl_C.CoderInfo.StorageClass = 'Custom';
Rail_nCloseCtl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pOpnCtl_C = Calibration.Parameter;
Rail_pOpnCtl_C.Value = 100;
Rail_pOpnCtl_C.CoderInfo.StorageClass = 'Custom';
Rail_pOpnCtl_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pMeUnCtlPWinPos_C = Calibration.Parameter;
Rail_pMeUnCtlPWinPos_C.Value = 100;
Rail_pMeUnCtlPWinPos_C.CoderInfo.StorageClass = 'Custom';
Rail_pMeUnCtlPWinPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pMeUnCtlPWinNeg_C = Calibration.Parameter;
Rail_pMeUnCtlPWinNeg_C.Value = 100;
Rail_pMeUnCtlPWinNeg_C.CoderInfo.StorageClass = 'Custom';
Rail_pMeUnCtlPWinNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pMeUnCtlIWinPos_C = Calibration.Parameter;
Rail_pMeUnCtlIWinPos_C.Value = 100;
Rail_pMeUnCtlIWinPos_C.CoderInfo.StorageClass = 'Custom';
Rail_pMeUnCtlIWinPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pMeUnCtlIWinNeg_C = Calibration.Parameter;
Rail_pMeUnCtlIWinNeg_C.Value = 100;
Rail_pMeUnCtlIWinNeg_C.CoderInfo.StorageClass = 'Custom';
Rail_pMeUnCtlIWinNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_pDvtFltMin_C = Calibration.Parameter;
Rail_pDvtFltMin_C.Value = 100;
Rail_pDvtFltMin_C.CoderInfo.StorageClass = 'Custom';
Rail_pDvtFltMin_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_nMeUnFrzI_C = Calibration.Parameter;
Rail_nMeUnFrzI_C.Value = 150;
Rail_nMeUnFrzI_C.CoderInfo.StorageClass = 'Custom';
Rail_nMeUnFrzI_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_tiFrzIDel_C = Calibration.Parameter;
Rail_tiFrzIDel_C.Value = 0;
Rail_tiFrzIDel_C.CoderInfo.StorageClass = 'Custom';
Rail_tiFrzIDel_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolMeUnCtlLoLim_C = Calibration.Parameter;
Rail_dvolMeUnCtlLoLim_C.Value = 10;
Rail_dvolMeUnCtlLoLim_C.CoderInfo.StorageClass = 'Custom';
Rail_dvolMeUnCtlLoLim_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolStrt_MAPX = Calibration.Parameter;
Rail_dvolStrt_MAPX.Value = [0 400 800 1200 1800 2200 2600 3000];
Rail_dvolStrt_MAPX.CoderInfo.StorageClass = 'Custom';
Rail_dvolStrt_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolStrt_MAPY = Calibration.Parameter;
Rail_dvolStrt_MAPY.Value = [-50 -30 -10 10 40 60 80 100];
Rail_dvolStrt_MAPY.CoderInfo.StorageClass = 'Custom';
Rail_dvolStrt_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolStrt_MAP = Calibration.Parameter;
...
Rail_dvolStrt_MAP.CoderInfo.StorageClass = 'Custom';
Rail_dvolStrt_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_stCtlLoopSel_C = Calibration.Parameter;
Rail_stCtlLoopSel_C.Value = 0;
Rail_stCtlLoopSel_C.CoderInfo.StorageClass = 'Custom';
Rail_stCtlLoopSel_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolOff_C = Calibration.Parameter;
Rail_dvolOff_C.Value = 0;
Rail_dvolOff_C.CoderInfo.StorageClass = 'Custom';
Rail_dvolOff_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolPRVCtlOfs_C = Calibration.Parameter;
Rail_dvolPRVCtlOfs_C.Value = 0;
Rail_dvolPRVCtlOfs_C.CoderInfo.StorageClass = 'Custom';
Rail_dvolPRVCtlOfs_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolMeUnCtlInitI_CURX = Calibration.Parameter;
Rail_dvolMeUnCtlInitI_CURX.Value = [-20 0 20 30 40 50];
Rail_dvolMeUnCtlInitI_CURX.CoderInfo.StorageClass = 'Custom';
Rail_dvolMeUnCtlInitI_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Rail_dvolMeUnCtlInitI_CUR = Calibration.Parameter;
Rail_dvolMeUnCtlInitI_CUR.Value = [500 800 800 800 800 800];
Rail_dvolMeUnCtlInitI_CUR.CoderInfo.StorageClass = 'Custom';
Rail_dvolMeUnCtlInitI_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
FlSys_stDeflate_C = Calibration.Parameter;
FlSys_stDeflate_C.Value = 0;
FlSys_stDeflate_C.CoderInfo.StorageClass = 'Custom';
FlSys_stDeflate_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
