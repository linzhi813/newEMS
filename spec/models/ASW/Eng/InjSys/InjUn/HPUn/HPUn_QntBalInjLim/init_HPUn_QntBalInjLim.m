...
HPUn_stNumInjMax_mp= Calibration.Signal;
...
HPUn_numInjQntBal= Calibration.Signal;
...
HPUn_pRailDvtFlt_mp= Calibration.Signal;
...
HPUn_stQntBal_mp= Calibration.Signal;
...
HPUn_tiQntBalDel_mp= Calibration.Signal;
...
HPUn_facPresDvtFlt_C = Calibration.Parameter;
HPUn_facPresDvtFlt_C.Value = 50;
HPUn_facPresDvtFlt_C.CoderInfo.StorageClass = 'Custom';
HPUn_facPresDvtFlt_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
HPUn_pRailDvtOk_C = Calibration.Parameter;
HPUn_pRailDvtOk_C.Value = 0.2;
HPUn_pRailDvtOk_C.CoderInfo.StorageClass = 'Custom';
HPUn_pRailDvtOk_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
HPUn_tiQntBalDel_C = Calibration.Parameter;
HPUn_tiQntBalDel_C.Value = 1000;
HPUn_tiQntBalDel_C.CoderInfo.StorageClass = 'Custom';
HPUn_tiQntBalDel_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
HPUn_numInjMin_C = Calibration.Parameter;
HPUn_numInjMin_C.Value = 2;
HPUn_numInjMin_C.CoderInfo.StorageClass = 'Custom';
HPUn_numInjMin_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
InjCrv_numInjMaxSys_C = Calibration.Parameter;
InjCrv_numInjMaxSys_C.Value = 5;
InjCrv_numInjMaxSys_C.CoderInfo.StorageClass = 'Custom';
InjCrv_numInjMaxSys_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
