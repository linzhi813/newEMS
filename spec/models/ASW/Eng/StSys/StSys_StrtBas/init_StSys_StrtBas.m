...
StSys_trqBas= Calibration.Signal;
...
StSys_trqStrtBas_mp= Calibration.Signal;
...
StSys_trqAdj_mp= Calibration.Signal;
...
StSys_trqStrtBas_MAP = Calibration.Parameter;
...
StSys_trqStrtBas_MAP.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtBas_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_trqStrtBas_MAPX = Calibration.Parameter;
StSys_trqStrtBas_MAPX.Value = [300 400 500 550 580 610 650 720 800 900 1209 1210 1211 1212 1213 1214];
StSys_trqStrtBas_MAPX.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtBas_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_trqStrtBas_MAPY = Calibration.Parameter;
StSys_trqStrtBas_MAPY.Value = [-30 -25 -20 -15 -10 -5 0 5 10 20 40 80 81 82 83 84];
StSys_trqStrtBas_MAPY.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtBas_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_nAdjMax_C = Calibration.Parameter;
StSys_nAdjMax_C.Value = 100;
StSys_nAdjMax_C.CoderInfo.StorageClass = 'Custom';
StSys_nAdjMax_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_trqAdjMax_C = Calibration.Parameter;
StSys_trqAdjMax_C.Value = 100;
StSys_trqAdjMax_C.CoderInfo.StorageClass = 'Custom';
StSys_trqAdjMax_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
