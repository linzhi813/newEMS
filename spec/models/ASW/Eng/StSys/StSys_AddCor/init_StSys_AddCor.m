...
StSys_trqAddCor= Calibration.Signal;
...
StSys_trqStrtAPS_MAPX = Calibration.Parameter;
StSys_trqStrtAPS_MAPX.Value = [0 200 400 600 1000 1200 1400 1600 2000 2200 2400 2600 4000 4200 4400 4600];
StSys_trqStrtAPS_MAPX.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtAPS_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_trqStrtAPS_MAPY = Calibration.Parameter;
StSys_trqStrtAPS_MAPY.Value = [-23 -13 -3 7 17 27 37 47 57 67 77 87 97 107 132 133 134 135];
StSys_trqStrtAPS_MAPY.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtAPS_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_trqStrtAPS_MAP = Calibration.Parameter;
...
StSys_trqStrtAPS_MAP.CoderInfo.StorageClass = 'Custom';
StSys_trqStrtAPS_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_facStrtAPS_CURX = Calibration.Parameter;
StSys_facStrtAPS_CURX.Value = [80 90 100 110 120 130 150 170];
StSys_facStrtAPS_CURX.CoderInfo.StorageClass = 'Custom';
StSys_facStrtAPS_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
StSys_facStrtAPS_CUR = Calibration.Parameter;
StSys_facStrtAPS_CUR.Value = [1 1 1 1 1 1 1 1];
StSys_facStrtAPS_CUR.CoderInfo.StorageClass = 'Custom';
StSys_facStrtAPS_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
