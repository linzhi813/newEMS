...
ASMod_facVolEff= Calibration.Signal;
...
ASMod_dmIndAirRef= Calibration.Signal;
...
ASMod_mAirPerCylCor= Calibration.Signal;
...
ASMod_facVolEffBas_mp= Calibration.Signal;
...
ASMod_facEGRCor_mp= Calibration.Signal;
...
ASMod_facVolEffTempCor_mp= Calibration.Signal;
...
ASMod_facVolEffBas_MAP = Calibration.Parameter;
ASMod_facVolEffBas_MAP.Value = ones(20);
ASMod_facVolEffBas_MAP.CoderInfo.StorageClass = 'Custom';
ASMod_facVolEffBas_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facVolEffBas_MAPY = Calibration.Parameter;
ASMod_facVolEffBas_MAPY.Value = linspace(600,4400,20);
ASMod_facVolEffBas_MAPY.CoderInfo.StorageClass = 'Custom';
ASMod_facVolEffBas_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facVolEffBas_MAPX = Calibration.Parameter;
ASMod_facVolEffBas_MAPX.Value = linspace(0,95,20);
ASMod_facVolEffBas_MAPX.CoderInfo.StorageClass = 'Custom';
ASMod_facVolEffBas_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facEGRCor_MAP = Calibration.Parameter;
ASMod_facEGRCor_MAP.Value = ones(20);
ASMod_facEGRCor_MAP.CoderInfo.StorageClass = 'Custom';
ASMod_facEGRCor_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facEGRCor_MAPY = Calibration.Parameter;
ASMod_facEGRCor_MAPY.Value = linspace(600,4400,20);
ASMod_facEGRCor_MAPY.CoderInfo.StorageClass = 'Custom';
ASMod_facEGRCor_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facEGRCor_MAPX = Calibration.Parameter;
ASMod_facEGRCor_MAPX.Value = linspace(5,100,20);
ASMod_facEGRCor_MAPX.CoderInfo.StorageClass = 'Custom';
ASMod_facEGRCor_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_tIntMnfDsRef_MAP = Calibration.Parameter;
ASMod_tIntMnfDsRef_MAP.Value = 300.*ones(20);
ASMod_tIntMnfDsRef_MAP.CoderInfo.StorageClass = 'Custom';
ASMod_tIntMnfDsRef_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_tIntMnfDsRef_MAPY = Calibration.Parameter;
ASMod_tIntMnfDsRef_MAPY.Value = linspace(600,4400,20);
ASMod_tIntMnfDsRef_MAPY.CoderInfo.StorageClass = 'Custom';
ASMod_tIntMnfDsRef_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_tIntMnfDsRef_MAPX = Calibration.Parameter;
ASMod_tIntMnfDsRef_MAPX.Value = linspace(0,95,20);
ASMod_tIntMnfDsRef_MAPX.CoderInfo.StorageClass = 'Custom';
ASMod_tIntMnfDsRef_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_facIntMnfDsTempCor_C = Calibration.Parameter;
ASMod_facIntMnfDsTempCor_C.Value = 1;
ASMod_facIntMnfDsTempCor_C.CoderInfo.StorageClass = 'Custom';
ASMod_facIntMnfDsTempCor_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_volEng_C = Calibration.Parameter;
ASMod_volEng_C.Value = 2;
ASMod_volEng_C.CoderInfo.StorageClass = 'Custom';
ASMod_volEng_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
ASMod_nThresDwn_C = Calibration.Parameter;
ASMod_nThresDwn_C.Value = 200;
ASMod_nThresDwn_C.CoderInfo.StorageClass = 'Custom';
ASMod_nThresDwn_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
