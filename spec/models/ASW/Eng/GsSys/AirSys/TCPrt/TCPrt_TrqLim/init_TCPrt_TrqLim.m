...
TCPrt_trqInrBstPrtLim= Calibration.Signal;
...
TCPrt_bTrbChOvrSpd_DSM= Calibration.Signal;
...
TCPrt_trqPrtLim_mp= Calibration.Signal;
...
TCPrt_bTrbChOvrSpd= Calibration.Signal;
...
TCPrt_nSpdMax_CURX = Calibration.Parameter;
TCPrt_nSpdMax_CURX.Value = [100 200 350 500 650 800 1000 1250 1500 2000 2500 3000 3500 4000 4500 5000];
TCPrt_nSpdMax_CURX.CoderInfo.StorageClass = 'Custom';
TCPrt_nSpdMax_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_nSpdMax_CUR = Calibration.Parameter;
TCPrt_nSpdMax_CUR.Value = [25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000 25000];
TCPrt_nSpdMax_CUR.CoderInfo.StorageClass = 'Custom';
TCPrt_nSpdMax_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_trqMax_CURX = Calibration.Parameter;
TCPrt_trqMax_CURX.Value = [100 200 350 500 650 800 1000 1250 1500 2000 2500 3000 3500 4000 4500 5000];
TCPrt_trqMax_CURX.CoderInfo.StorageClass = 'Custom';
TCPrt_trqMax_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_trqMax_CUR = Calibration.Parameter;
TCPrt_trqMax_CUR.Value = [300 300 300 300 300 300 300 300 300 300 300 300 300 300 300 300];
TCPrt_trqMax_CUR.CoderInfo.StorageClass = 'Custom';
TCPrt_trqMax_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_trqOpnLop_MAPX = Calibration.Parameter;
TCPrt_trqOpnLop_MAPX.Value = [50 60 70 80 90 100 110 120 130 140 150 160 170 180 190 200];
TCPrt_trqOpnLop_MAPX.CoderInfo.StorageClass = 'Custom';
TCPrt_trqOpnLop_MAPX.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_trqOpnLop_MAPY = Calibration.Parameter;
TCPrt_trqOpnLop_MAPY.Value = [100 200 350 500 650 800 1000 1250 1500 2000 2500 3000 3500 4000 4500 5000];
TCPrt_trqOpnLop_MAPY.CoderInfo.StorageClass = 'Custom';
TCPrt_trqOpnLop_MAPY.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_trqOpnLop_MAP = Calibration.Parameter;
...
300 300 300 300 300 300 300 300 300 300 300 300 300 300 300 300;
300 300 300 300 300 300 300 300 300 300 300 300 300 300 300 300];
TCPrt_trqOpnLop_MAP.CoderInfo.StorageClass = 'Custom';
TCPrt_trqOpnLop_MAP.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_tiOvrSpdDebDef_C = Calibration.Parameter;
TCPrt_tiOvrSpdDebDef_C.Value = 100;
TCPrt_tiOvrSpdDebDef_C.CoderInfo.StorageClass = 'Custom';
TCPrt_tiOvrSpdDebDef_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
TCPrt_tiOvrSpdDebOk_C = Calibration.Parameter;
TCPrt_tiOvrSpdDebOk_C.Value = 100;
TCPrt_tiOvrSpdDebOk_C.CoderInfo.StorageClass = 'Custom';
TCPrt_tiOvrSpdDebOk_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
