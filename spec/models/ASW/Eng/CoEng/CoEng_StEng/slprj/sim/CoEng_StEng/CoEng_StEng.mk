...
MODEL                = CoEng_StEng
MODULES              = CoEng_StEng.c CoEng_StEng_capi.c 
MAKEFILE             = CoEng_StEng.mk
MATLAB_ROOT          = C:/MATLAB/R2016b
ALT_MATLAB_ROOT      = C:/MATLAB/R2016b
MATLAB_BIN           = C:/MATLAB/R2016b/bin
ALT_MATLAB_BIN       = C:/MATLAB/R2016b/bin
MASTER_ANCHOR_DIR    = 
...
GEN_SAMPLE_MAIN      = 0
MEX_OPT_FILE         = -f C:/MATLAB/R2016b/rtw/c/tools/LCC-WI~1.XML
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/sim/CoEng_StEng \
	-I$(START_DIR) \
...
CFLAGS = $(CC_OPTS) $(DEFINES_CUSTOM) $(CPP_REQ_DEFINES) $(INCLUDES) -w -noregistrylookup 
