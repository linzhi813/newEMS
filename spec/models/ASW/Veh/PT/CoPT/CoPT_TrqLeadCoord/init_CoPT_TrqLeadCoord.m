...
CoPT_trqLead= Calibration.Signal;
...
CoPT_trqCurr= Calibration.Signal;
...
CoPT_trqLeadClth= Calibration.Signal;
...
CoPT_tiDebLead_C = Calibration.Parameter;
CoPT_tiDebLead_C.Value = 5000;
CoPT_tiDebLead_C.CoderInfo.StorageClass = 'Custom';
CoPT_tiDebLead_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
CoPT_dtrqLeadCorP_Pos_C  = Calibration.Parameter;
CoPT_dtrqLeadCorP_Pos_C .Value = 1000;
CoPT_dtrqLeadCorP_Pos_C .CoderInfo.StorageClass = 'Custom';
CoPT_dtrqLeadCorP_Pos_C .CoderInfo.CustomStorageClass = 'ConstVolatile';
...
CoPT_dtrqLeadCorP_Neg_C = Calibration.Parameter;
CoPT_dtrqLeadCorP_Neg_C.Value = 50;
CoPT_dtrqLeadCorP_Neg_C.CoderInfo.StorageClass = 'Custom';
CoPT_dtrqLeadCorP_Neg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
CoPT_tiDebCurr_C = Calibration.Parameter;
CoPT_tiDebCurr_C.Value = 0;
CoPT_tiDebCurr_C.CoderInfo.StorageClass = 'Custom';
CoPT_tiDebCurr_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
CoPT_dtrqCurrCorP_Pos_C = Calibration.Parameter;
CoPT_dtrqCurrCorP_Pos_C.Value = 1000;
CoPT_dtrqCurrCorP_Pos_C.CoderInfo.StorageClass = 'Custom';
CoPT_dtrqCurrCorP_Pos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
CoPT_dtrqCurrCorP_Neg_C = Calibration.Parameter;
CoPT_dtrqCurrCorP_Neg_C.Value = 50;
CoPT_dtrqCurrCorP_Neg_C.CoderInfo.StorageClass = 'Custom';
CoPT_dtrqCurrCorP_Neg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
