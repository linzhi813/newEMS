...
PT_GripCfg_CW = Simulink.Parameter;
PT_GripCfg_CW.Value = 0;
PT_GripCfg_CW.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_rClthSlip_C = Simulink.Parameter;
PT_rClthSlip_C.Value = 0.5;
PT_rClthSlip_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_rClthSlipDeb_C = Simulink.Parameter;
PT_rClthSlipDeb_C.Value = 0.7;
PT_rClthSlipDeb_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_rGrip_C = Simulink.Parameter;
PT_rGrip_C.Value = 1;
PT_rGrip_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_rGripDfl_C = Simulink.Parameter;
PT_rGripDfl_C.Value = 0;
PT_rGripDfl_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_rNoGrip_C = Simulink.Parameter;
PT_rNoGrip_C.Value = 0;
PT_rNoGrip_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_tiDebClthStSlip_C = Simulink.Parameter;
PT_tiDebClthStSlip_C.Value = 3000;
PT_tiDebClthStSlip_C.CoderInfo.StorageClass = 'ImportedExtern';
...
PT_vMinGrip_C = Simulink.Parameter;
PT_vMinGrip_C.Value = 0;
PT_vMinGrip_C.CoderInfo.StorageClass = 'ImportedExtern';
