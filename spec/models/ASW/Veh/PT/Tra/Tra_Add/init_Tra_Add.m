...
Tra_rClgDem= Calibration.Signal;
...
Tra_tClntDes= Calibration.Signal;
...
Tra_bCanAirCanPtd_C = Calibration.Parameter;
Tra_bCanAirCanPtd_C.Value = 0;
Tra_bCanAirCanPtd_C.CoderInfo.StorageClass = 'Custom';
Tra_bCanAirCanPtd_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Tra_rClgDem_C = Calibration.Parameter;
Tra_rClgDem_C.Value = 0;
Tra_rClgDem_C.CoderInfo.StorageClass = 'Custom';
Tra_rClgDem_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Tra_bCanClntCanPtd_C = Calibration.Parameter;
Tra_bCanClntCanPtd_C.Value = 0;
Tra_bCanClntCanPtd_C.CoderInfo.StorageClass = 'Custom';
Tra_bCanClntCanPtd_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Tra_tClntDes_C = Calibration.Parameter;
Tra_tClntDes_C.Value = 0;
Tra_tClntDes_C.CoderInfo.StorageClass = 'Custom';
Tra_tClntDes_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
