...
Fans_rClgDesFan= Calibration.Signal;
...
Fans_rCoolgDmdFan_mp= Calibration.Signal;
...
Fans_facVelCorErr_C = Calibration.Parameter;
Fans_facVelCorErr_C.Value = 0;
Fans_facVelCorErr_C.CoderInfo.StorageClass = 'Custom';
Fans_facVelCorErr_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Fans_RmpSlpPos_C = Calibration.Parameter;
Fans_RmpSlpPos_C.Value = 10;
Fans_RmpSlpPos_C.CoderInfo.StorageClass = 'Custom';
Fans_RmpSlpPos_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Fans_RmpSlpNeg_C = Calibration.Parameter;
Fans_RmpSlpNeg_C.Value = 10;
Fans_RmpSlpNeg_C.CoderInfo.StorageClass = 'Custom';
Fans_RmpSlpNeg_C.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Fans_facVelCor_CUR = Calibration.Parameter;
Fans_facVelCor_CUR.Value = [0 0.2 0.4 0.6 0.8 1];
Fans_facVelCor_CUR.CoderInfo.StorageClass = 'Custom';
Fans_facVelCor_CUR.CoderInfo.CustomStorageClass = 'ConstVolatile';
...
Fans_facVelCor_CURX = Calibration.Parameter;
Fans_facVelCor_CURX.Value = [0 20  40  60  80  100];
Fans_facVelCor_CURX.CoderInfo.StorageClass = 'Custom';
Fans_facVelCor_CURX.CoderInfo.CustomStorageClass = 'ConstVolatile';
