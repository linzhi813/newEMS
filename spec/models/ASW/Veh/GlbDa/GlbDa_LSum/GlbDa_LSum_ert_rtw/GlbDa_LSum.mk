###########################################################################
## Makefile generated for Simulink model 'GlbDa_LSum'. 
## 
## Makefile     : GlbDa_LSum.mk
## Generated on : Wed Jul 15 08:56:15 2020
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GlbDa_LSum.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/T3NSE/trunk/spec/model/swCore/ASW/Veh/GlbDa/GlbDa_LSum
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = GlbDa_LSum_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = GlbDa_LSum_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GlbDa_LSum.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/GlbDa_LSum_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=GlbDa_LSum -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/GlbDa_LSum_ert_rtw/CaliData.c $(START_DIR)/GlbDa_LSum_ert_rtw/GlbDa_LSum.c
...
OBJS = CaliData.obj GlbDa_LSum.obj
...
%.obj : $(START_DIR)/GlbDa_LSum_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
